	...
	init : function(parameter){
		...
		thisObj.thisBindEventClick = {
            ...
            radiusDrawPoorNum : function(){
                ...
                thisObj.thisEventProcessing.genData(thisObj.tScale*WIDTH,cxt);
            },
        ...
        thisObj.thisEventProcessing = {
          ...
          outOfPoorRadius : function(cxt,x,y,r){
            ...
            cxt.beginPath();
            cxt.arc(x,y,r-40,-0.5*Math.PI,-0.5*Math.PI-2*value*Math.PI,true);
            cxt.stroke();
          ...
          drawRightRect : function(cxt,x,y){
            ...
            cxt.lineWidth = "24";
            cxt.beginPath();
            cxt.moveTo(x-18,y-15);
            cxt.lineTo(x-18,y+15);
            cxt.closePath();
            cxt.stroke();
          },
          // 绘制左边的文字
          drawLeftfont : function(cxt,x,y,r){ 
            ...
            cxt.lineWidth = "1";
            cxt.font = thisObj.tScale*18+"px 黑体-简";
            cxt.fillStyle = "#95fbb3"; 
            var fontDrawHeight = thisObj.thisEventProcessing.returnNum(x,y,r);  // 绘制字体的Y坐标 如果y坐标小于字体高度时  字体就会被覆盖  需要加上他们的差值
            // 绘制文字
            cxt.fillText(beenPN+"人",x/5,fontDrawHeight);
            cxt.font = thisObj.tScale*18+"px 黑体";
            cxt.fillText("已脱贫",x/5,fontDrawHeight+65);
          },
          // 绘制右边的文字
          drawRightfont : function(cxt,x,y,r){
            ...
            cxt.fillText("未脱贫",x/5*8-40,fontDrawHeight+65);
          },
        ...
        thisObj.thisEventProPoorRea = {
            ...
            drawRect : function(cxt,WIDTH){
                ...
                var x = WIDTH/2;
                var y = WIDTH/10*3.3+5;
                var R = WIDTH/10*3.3-65;
                 // 绘制边上的圆弧部分
        ...
        thisObj.thisEventProTable = {
            ...
            deawTableFont : function(cxt,WIDTH){
                ...
                $.each(thisObj.thisSelector.year,function(index){
                    cxt.fillText(thisObj.thisSelector.year[index].data.year1,WIDTH/9*(2.5+index)-25,300);
