...
<canvas id="canvas" ></canvas>
  ...
  <div class="container">
      ...
      <div class="row area">
          <div class="col-sm-6 col-md-5 col-lg-4 area_money">
              ...
              <div class="area_money_key"><span class="area_money_value" id="out_poor_funds">0</span>万</div>
          </div>
          <div class="col-sm-6 col-md-6 col-lg-5  area_money">
              ...
              <div class="area_money_img">
                ...
                <div class="img_num"><span class="img_num_text" id="per_num">0</span>人</div>
              </div>
      ...
      <div class="row con">
          ...
          <div class="col-sm-6 col-md-6 col-lg-5 con_map">
              <div class="map">
                ...
                <div class="map5" style="overflow: hidden; border-radius:50%; ">
                    <div class="map_area">
                      <?php
  ...
  <div class="container">
      <div class="row con1 con_anim">
          <div class=" col-lg-4 ">
            <a href="/fpb/tmpl/home/townOutOfPoorData.php">
              <div class="menu">
