THISFILEMENU = {
	...
	addEvent: function() {
		//  点击文件管理页面上几个对文件操作按钮 
		$(".right-wrap").delegate(".btn_item", "click", function(e) {
			...
			switch(index) {
				...
				case 1: // 下载
					...
					break;
				case 2: // 分享
					THISFILEMENU.fileOperating.shareFile();
					break;
				case 3: // 移动
	...
	fileOperating: { //  文件操作方法集 
		...
		shareFile: function() { //  分享文件
			parent.Public.openWin('page/yunpan/shareFile/shareFile.html', '共享文件(夹)', 600, 450, function(index, layero) {
