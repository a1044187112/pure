		...
		DateTimePicker.prototype = {
			...
			_modifyPicker: function()
			{
				...
				if(bDisplaySetButton)
					sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonSet' style='background: rgb(40,199,218);'>" + dtPickerObj.settings.setButtonContent + "</a>";
				if(bDisplayClearButton)
					sDTPickerButtons += "<a class='dtpicker-button dtpicker-buttonClear' style='background: rgb(225,228,230);'>" + dtPickerObj.settings.clearButtonContent + "</a>";
