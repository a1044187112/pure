...
function($) {
	...
	$.jgrid = $.jgrid || {}, $.extend($.jgrid, {
		...
		return this.each(function() {
			if (!this.grid) {
				...
				var e, f;
				if (0 === this.p.colNames.length) for (e = 0; e < this.p.colModel.length; e++) this.p.colNames[e] = this.p.colModel[e].label || this.p.colModel[e].name, this.p.colModel[e].nameExt && (this.p.colNames[e] += this.p.colModel[e].nameExt);
				...
				var j = ["shiftKey", "altKey", "ctrlKey"],
					...
					u = function(a) {
						...
						} else for (d = 0; f > d; d++) e = $.jgrid.getAccessor(c.p.data[d], b), void 0 === e && (e = String(d + 1)), c.p._index[e] = d
					},
					...
					w = function(a, b, d, e, f) {
						...
						if (h && (c.p.data = [], c.p._index = {}, c.p.localReader.id = i), c.p.reccount = 0, $.isXMLDoc(a)) {
							...
							c.p.subGrid === !0 && (G = 1, w = $.jgrid.getMethod("addSubGridCell")), j.repeatitems || (I = r(l)), x = c.p.keyName === !1 ? $.isFunction(j.id) ? j.id.call(c, a) : j.id : c.p.keyName, y = -1 === String(x).indexOf("[") ? I.length ?
							function(a, b) {
								return $(x, a).text() || b
							} : function(a, b) {
					...
					E = function(a, b) {
						...
						if ("rtl" === f && (o += p), c.p.pginput === !0 && (n = "<td dir='" + f + "'>" + $.jgrid.format(c.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), c.p.pgbuttons === !0) {
							...
							"rtl" === f && s.reverse(), o += "<td id='" + s[0] + "' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-step-backward'></span></td>", o += "<td id='" + s[1] + "' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-backward'></span></td>", o += "" !== n ? m + n + m : "", o += "<td id='" + s[2] + "' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-forward'></span></td>", o += "<td id='" + s[3] + "' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-step-forward'></span></td>"
						} else "" !== n && (o += n);
				...
				$(c).before(d.hDiv).click(function(a) {
					...
					else if (c.p.multiselect && c.p.multiboxonly) if (b) $(c).jqGrid("setSelection", ma, !0, a);
					else {
		...
		getRowData: function(a) {
			...
			return this.each(function() {
				...
				for (; c > f;) e && (h = i.rows[f]), $(h).hasClass("jqgrow") && ($('td[role="gridcell"]', h).each(function(a) {
					...
					if ($.isFunction(i.p.formatCell)) {
						var c = i.p.formatCell.call(i, h.id, g, d[g], $(h).index(), a);
						void 0 !== c && (d[g] = c)
					}
				}), e && (b.push(d), d = {})), f++
			}), b || d
							...
							case "select":
								if (h = this.surl || g.dataUrl) j = q, a(j).append(r), a.ajax(a.extend({
									...
									if (m.searchoptions ? (u = void 0 === m.searchoptions.value ? "" : m.searchoptions.value, v = void 0 === m.searchoptions.separator ? ":" : m.searchoptions.separator, w = void 0 === m.searchoptions.delimiter ? ";" : m.searchoptions.delimiter) : m.editoptions && (u = void 0 === m.editoptions.value ? "" : m.editoptions.value, v = void 0 === m.editoptions.separator ? ":" : m.editoptions.separator, w = void 0 === m.editoptions.delimiter ? ";" : m.editoptions.delimiter), u) {
										...
										var y, z, A, B;
										if ("string" == typeof u) for (k = u.split(w), B = 0; B < k.length; B++) y = k[B].split(v), z = document.createElement("option"), z.value = y[0], z.innerHTML = y[1], x.appendChild(z);
	...
	a.extend(a.jgrid, {
		...
		createModal: function(b, c, d, e, f, g, h) {
			...
			if (d.resize) if (a.fn.jqResize) a(j).append("<div class='jqResize ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se'></div>"), a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", b.scrollelm ? "#" + a.jgrid.jqID(b.scrollelm) : !1);
			else try {
				a(j).resizable({
					handles: "se, sw",
		...
		info_dialog: function(b, c, d, e) {
			...
			a.fn.jqm && !g && (g = !1);
			var i, j = "";
			if (f.buttons.length > 0) for (i = 0; i < f.buttons.length; i++) void 0 === f.buttons[i].id && (f.buttons[i].id = "info_button_" + i), j += "<a href='javascript:void(0)' id='" + f.buttons[i].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[i].text + "</a>";
	...
	a.jgrid.extend({
		editCellByColName: function(b, c, d) {
			return this.each(function() {
				...
				if (e = a(g.rows[b + ""]).index(), a(g.rows).each(function(c) {
					var d = a(this);
					d[0].id === b && (e = d.index())
				}), e) if (a.each(g.p.colModel, function(a, b) {
		...
		saveCells: function() {
			return this.each(function() {
				var b = this;
				if (b.grid && b.p.cellEdit === !0 && b.p.savedRow.length >= 1) for (var c = 0; c < b.p.savedRow.length; c++) {
