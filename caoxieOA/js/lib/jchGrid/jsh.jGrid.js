...
(function (jch) {
    ...
    (function (Core) {
        ...
        function getDataByNS(obj, ns) {
            ...
            arr = $.grep(ns.replace(/^[\s\.]*|[\s\.]*$|[^\w\. ]/g, "").replace(/\.{2,}/, ".").split("."), function (n) {
                return n.length > 0;
            });
            return arr.length == 0 ? result : getObj(result, arr);
        ...
        function getBoolByStr(boolStr, defaultValue) {
            convert: {
                ...
                var bool = (boolStr === trueStr) ? true : ((boolStr === falseStr) ? false : null);
...
//# sourceMappingURL=jch.Core.js.map
...
(function ($) {
        ...
        function setExpand() {
            ...
            function expandBtnClick(e, cell, cdata, rdata, $exp) {
                ...
                if (cell.row.getIsExpand()) {
                    ...
                    $exp.removeClass("_expand").addClass("collapse");
                } else {
                    //开启展开行
    ...
    function jRow(jgrid, cfg) {
        ...
        jRow.prototype.getCheckBox = function () {
            var _this = this;
            var jcbCell = _this.getCell("_checkbox");
